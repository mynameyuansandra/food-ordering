...
$monitoring = query("SELECT * FROM konf_pembayaran WHERE nama = '$nama' ORDER BY idkonfir_bayar DESC");
        ...
        <div class="container">
            <div class="col-md-12">
                <ul class="breadcrumb">
                    ...
                    <li class="li">Data Detail Pembayaran</li>
                </ul>
            </div>
                            ...
                            <?php foreach ($monitoring as $row) : ?>
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="deletepembayarancustomer.php?id=<?php echo $row['idkonfir_bayar']; ?>" onclick="return confirm('Apakah anda yakin ingin menghapus')" ; class="btn btn-danger btn-xs" style="margin-right:0;"><i class="fa fa-trash-o" aria-hidden="true"></i>
                                            </a> |

                                            <a href="updatepembayarancustomer.php?id=<?php echo $row['idkonfir_bayar']; ?>" class="btn btn-info btn-xs" style="margin-right:0;"><i class="fa fa-trash-o" aria-hidden="true"></i>
                                            </a>
                                            |
                                            <a href="cetakpembayarancustomer.php" target="_blank" class="btn btn-primary btn-xs" style="margin-right:0;"><i class="fa fa-print" aria-hidden="true"></i></i>
                                            </a>
                                        </td>
