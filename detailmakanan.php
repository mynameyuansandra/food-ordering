...
if (!isset($_GET['q']) || !isset($_GET['id'])) {
    ...
    $detail = query("SELECT * FROM detail_order WHERE menu LIKE '$q'");
          ...
          <div class="col-md-9">
              <div class="box">
                  ...
                  <div class="row">
                    ...
                    <div class="product">
                        <a href="details.php">
                        <img src="img/<?= $makanan['gambar'] ?>" class="img-responsive" alt="product">
                        </a>
                        ...
                        <div class="col-sm-6">
                    <div class="box">
                        <h2 class="text-center"><?php echo $detail['menu']; ?></h2>
                        <br>
                            <h4 style="font-weight: bold; font-style:italic">Harga : <?php echo $detail['harga']; ?></h4>
                            <h4 style="font-weight: bold; font-style:italic">Stok : In Stok (<?php echo $detail['stok']; ?>)</h4>
                            <h4 style="font-weight: bold; font-style:italic">Keterangan : <?php echo $detail['keterangan']; ?></h4>
                        </div>
                        </div>
