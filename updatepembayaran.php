                    ...
                    <div class="form-group">
                          ...
                          <div class="form-group">
                              ...
                              <input type="text" class="form-control" id="namapenyetor" name="namapenyetor" 
                                  placeholder="" value="<?php echo $pembayaran['nama'];?>">
                              </div>
                          </div>
                          ...
                          <div class="form-group">
                              ...
                              <input type="text" class="form-control" id="bank" name="bank" 
                                  placeholder="" value="<?php echo $pembayaran['bank'];?>">
                              </div>
                          </div>
                          ...
                          <div class="form-group">
                              ...
                              <input type="text" class="form-control" id="harga" name="harga" 
                                  placeholder="" readonly="" value="<?php echo $pembayaran['total_harga']; ?>">
                              </div>
                          </div>
                          ...
                          <div class="form-group">
                              ...
                              <input type="date" class="form-control" id="tanggal" name="tanggal" 
                                  placeholder="" value="<?php echo $pembayaran['tanggal'];?>">
                              </div>
                          </div>
