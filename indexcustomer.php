    ...
    <div class="container">
      ...
      <div class="col-md-6">
        ...
        <ul class="menu">
          ...
          <li>
            <a href="loginadmin.php" class="customer">Login Admin</a>
          </li>
  ...
  <div id="navbar" class="navbar navbar-default">
    ...
    <div class="container">
      ...
      <div class="navbar-collapse collapse" id="navigation">
        ...
        <a href="cartcustomer.php" class="btn navbar-btn btn-primary right">
          <i class="fa fa-shopping-cart mr-auto"></i>
          <span><?= $cart['jumlah_pesan'] ?> Item<?= $cart['jumlah_pesan'] > 1 ? 's' : '' ?> in Your Cart</span>
        </a>
