...
if (isset($_POST['btnpembayaran'])) {
    if (konfirmasipembayaran($_POST) > 0) {
        echo "<script>
            ...
            window.location.href='checkoutcustomer.php';
        </script>";
    } else {
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-group">
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" id="namapenyetor" name="namapenyetor" placeholder="">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" id="harga" name="harga" placeholder="" readonly="" value="<?php echo number_format($pembayaran['harga']); ?>">
                                    </div>
                                </div>
