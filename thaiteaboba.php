...
<!-- order -->
         <div class="col-md-9">
             <div id="productMain" class="row">
                         ...
                         <div id="myCarousel" class="carousel slide" data-ride="carousel">
                             ...
                             <div class="carousel-inner">
                                 <div class="item active">
                                     <center><img class="img-responsive" src="imagesminuman/thaiteaboba.jpg" alt="Product 3-a"></center>
                                 </div>
                                 <div class="item">
                ...
                <div class="col-sm-6">
                    <div class="box">
                        <h1 class="text-center">Thai Tea Boba</h1>
                        ...
                        <?php
                            ...
                            <div class="form-group">
                                ...
                                <?php $gambar = query("SELECT * FROM stok_makanan_masuk")[16] ?>
                                <div class="col-md-7">
