...
if(isset($_POST['btnstokmakanan']))
{
    if(stokmakanan($_POST) > 0)
    {
        echo "<script>
            alert('Input Data Success !');
            window.location.href='stokmakanan.php';
        </script>";
    } 
              ...
              <div class="box">
                  <div class="box-header">
                      ...
                      <form action="" method="post" enctype="multipart/form-data">
                          ...
                          <button type="submit" name="btnstokmakanan" class="btn btn-success">Input Data</button>
                      </form>
                  </div>
              </div>
          </div>
