...
$formcheck = query("SELECT * FROM form_check ORDER BY id_form DESC");


if(isset($_POST['submit']))
{
	$formcheck = cariform($_POST['search']);
}
          ...
          <div class="col-md-9">
              ...
              <tbody>
                <tr>
                  ...
                  <td><?= $row['qty']; ?></td>
                  <td> 
                    <a href="deleteformcheck.php?id=<?php echo $row['id_form']; ?>"
                    ...
                    <a href="updateformcheck.php?id=<?php echo $row['id_form']; ?>"
                      class="btn btn-info btn-xs"
                      style="margin-right:0;"><i class="fa fa-trash-o" aria-hidden="true"></i>
                    </a> |
                    <a href="cetakformcheck.php"  target="_blank"
