          ...
          <div class="col-md-9">
              <div class="box">
                  ...
                  <thead>
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="konfirmasipembayaran.php?id=<?php echo $row['id_order']; ?>" class="btn btn-primary"  style="margin-bottom:20px;" target="_blank">
                                        Pembayaran 
                                </a>
                                        </td>
                ...
                <div class="pull-right">
                                <a href="cetakcheckout.php" class="btn btn-primary"  style="margin-bottom:20px;" target="_blank">
