...
if (isset($_POST['pesan'])) {
    if (pesan($_POST) > 0) {
        echo "<script>
            ...
            window.location.href='pesanmakanancustomer.php?id=$id';
        </script>";
    } else {
        echo "<script>
                        ...
                        <div class="box">
                            ...
                            <form action="" class="form-horizontal" method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-7">
                                        <input type="text" class="form-control" name="namamakanan" id="namamakanan" value="<?= $makanan['nama_makanan'] ?>" readonly="">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-7">
                                        <input type="text" class="form-control" name="nama_pelanggan" value="<?= $_SESSION['username'] ?>" readonly id="namapelanggan">
                                ...
                                <p class="text-center buttons control-label"><button type="submit" name="pesan" class="btn btn-primary" id="btn">Pesan</button></p>
                            </form>
                        </div>
