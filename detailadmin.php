...
$monitoring = query("SELECT * FROM adminis ORDER BY id_pegawai_admin DESC");
          ...
          <div class="col-md-9">
              ...
              <tbody>
                ...
                <td><?php echo $numb; ?></td>
                  ...
                  <td> 
                    <a href="delete.php?id=<?php echo $row['id_pegawai_admin']; ?>"
                    ...
                    <a href="update.php?id=<?php echo $row['id_pegawai_admin']; ?>"
