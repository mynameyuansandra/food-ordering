                         ...
                         <div id="myCarousel" class="carousel slide" data-ride="carousel">
                             ...
                             <div class="carousel-inner">
                                 <div class="item active">
                                     <center><img class="img-responsive" src="imagesmakanan/esbuah.jpg" alt="Product 3-a"></center>
                                 </div>
                                 <div class="item">
                                     <center><img class="img-responsive" src="imagesmakanan/escampur.jpg" alt=""></center>
                                 </div>
                                 <div class="item">
                                     <center><img class="img-responsive" src="imagesminuman/thaiteaboba.jpg" alt=""></center>
                                 </div>
                             </div>
                ...
                <div class="col-sm-6">
                    <div class="box">
                        ...
                        <label for="nama">Password :</label>
                            ...
                            <a href="registrasimakanan.php">Registrasi</a>
                            <p class="text-center buttons"><button type="submit" class="btn btn-primary" name="loginakunsate">Login</button></p>
                        </form>
                        </div>
                    </div>
                    ...
                    <div class="row" id="thumbs">
                        ...
                        <img src="imagesmakanan/esbuah.jpg" alt="product 1" class="img-responsive"></a>
                        </div>

                        <div class="col-xs-4">
                        <a data-target="#myCarousel" data-slide-to="1" href="#" class="thumb">
                        <img src="imagesmakanan/escampur.jpg" alt="product 1" class="img-responsive"></a>
                        </div>

                        <div class="col-xs-4">
                        <a data-target="#myCarousel" data-slide-to="2" href="#" class="thumb">
                        <img src="imagesminuman/thaiteaboba.jpg" alt="product 1" class="img-responsive"></a>
                        </div>
