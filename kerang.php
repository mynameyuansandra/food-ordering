...
<!-- order -->
         <div class="col-md-9">
             <div id="productMain" class="row">
                         ...
                         <div id="myCarousel" class="carousel slide" data-ride="carousel">
                             ...
                             <div class="carousel-inner">
                                 <div class="item active">
                                     <center><img class="img-responsive" src="imagesmakanan/kerang.jpeg" alt="Product 3-a"></center>
                                 </div>
                                 <div class="item">
                                     <center><img class="img-responsive" src="imagesmakanan/kerang.jpeg" alt=""></center>
                                 </div>
                                 <div class="item">
                                     <center><img class="img-responsive" src="imagesmakanan/kerang.jpeg" alt=""></center>
                                 </div>
                ...
                <div class="col-sm-6">
                    <div class="box">
                        <h1 class="text-center">Kerang</h1>
                            ...
                            ?>
                             ...
                             <!-- div.col-md-7>select.form-control>option*5 -->
                              ...
                              <div class="form-group">
                                ...
                                <?php $gambar = query("SELECT * FROM stok_makanan_masuk")[6] ?>
                                <div class="col-md-7">
                    ...
                    <div class="row" id="thumbs">
                        ...
                        <img src="imagesmakanan/kerang.jpeg" alt="product 1" class="img-responsive"></a>
                        </div>
