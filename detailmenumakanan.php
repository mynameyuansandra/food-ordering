...
$monitoring = query("SELECT * FROM menu_makan ORDER BY id_menu DESC");




if (isset($_POST['cari'])) {
  $monitoring = caridetailmenumakanan($_POST['search']);
}
            ...
            <div class="form-group">
              <div class="input-group">
                ...
                <div class="pull-right">
                  <a href="cetaksemuamakanan.php" class="btn btn-primary" style="margin-bottom:20px;" target="_blank">
              ...
              <?php foreach ($monitoring as $row) : ?>
                ...
                <tbody>
                  <tr>
                    ...
                    <td><?= $row['harga']; ?></td>
                    <td>
                      <a href="deletemenumakan.php?id=<?php echo $row['id_menu']; ?>" onclick="return confirm('Apakah anda yakin ingin menghapus')" ; class="btn btn-danger btn-xs" style="margin-right:0;"><i class="fa fa-trash-o" aria-hidden="true"></i>
                      </a> |


                      <a href="cetakmenumakan.php?id=<?php echo $row['id_menu']; ?>" target="_blank" class="btn btn-primary btn-xs" style="margin-right:0;"><i class="fa fa-print" aria-hidden="true"></i></i>
                      </a>
                    </td>
