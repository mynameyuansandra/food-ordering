                  ...
                  <div class="box-header">
                      ...
                      <div class="form-group">
                              ...
                              <input type="text" class="form-control" name="namapelanggan" 
                                  placeholder="" value="<?php echo $updateorder['nama_pelanggan']; ?>">
                              </div>
                          </div>
                      ...
                      <div class="form-group">
                          ...
                          <div class="form-group">
                              ...
                              <input type="number" class="form-control" name="jumlahpesan" 
                                  placeholder="" readonly="" value="<?php echo $updateorder['jumlah_pesan']; ?>">
                              </div>
                          </div>
                          ...
                          <div class="form-group">
                              ...
                              <input type="number" class="form-control" name="harga" 
                                  placeholder="" readonly="" value="<?php echo $updateorder['harga']; ?>">
                              </div>
                          </div>
                          ...
                          <div class="form-group">
                              ...
                              <input type="date" class="form-control" name="tanggal" 
                                  placeholder="Masukkan nama pemesan" value="<?php echo $updateorder['tanggal']; ?>">
                              </div>
                          </div>
