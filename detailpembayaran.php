...
$monitoring = query("SELECT * FROM konf_pembayaran ORDER BY idkonfir_bayar DESC");




if (isset($_POST['cari'])) {
  $monitoring = caripembayaran($_POST['search']);
}
            ...
            <div class="form-group">
              <div class="input-group">
                ...
                <div class="pull-right">
                  <a href="cetaksemuapembayaran.php" class="btn btn-primary" style="margin-bottom:20px;" target="_blank">
              ...
              <?php foreach ($monitoring as $row) : ?>
                ...
                <tbody>
                  <tr>
                    ...
                    <td><?= $row['tanggal']; ?></td>
                    <td><img src="img/<?php echo $row['bukti']; ?>" width="50" alt=""></td>
                    <td>
                      <a href="deletepembayaran.php?id=<?php echo $row['idkonfir_bayar']; ?>" onclick="return confirm('Apakah anda yakin ingin menghapus')" ; class="btn btn-danger btn-xs" style="margin-right:0;"><i class="fa fa-trash-o" aria-hidden="true"></i>
                      </a> |

                      <a href="updatepembayaran.php?id=<?php echo $row['idkonfir_bayar']; ?>" class="btn btn-info btn-xs" style="margin-right:0;"><i class="fa fa-trash-o" aria-hidden="true"></i>
                      </a>
                      |
                      <a href="cetakpembayaran.php?id=<?php echo $row['idkonfir_bayar']; ?>" target="_blank" class="btn btn-primary btn-xs" style="margin-right:0;"><i class="fa fa-print" aria-hidden="true"></i></i>
                      </a>
                    </td>
