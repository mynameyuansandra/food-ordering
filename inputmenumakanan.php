...
if(isset($_POST['btnmenumakan']))
{
    if(menumakan($_POST) > 0)
    {
        echo "<script>
                  ...
                  <div class="box-header">
                      ...
                      ?>  
                          ...
                          while ($row = mysqli_fetch_array($result)) {  
                               echo '<option name="stok_menu_makanan" value="'.$row['nama_makanan'] . '">' . $row['nama_makanan'] . '</option>';   
                          $a .= "harga['" . $row['nama_makanan'] . "'] = {harga:'" . addslashes($row['harga'])."'};\n";  
                          ...
                          <button type="submit" name="btnmenumakan" class="btn btn-success">Input Data</button>
                      </form>
                  </div>
              </div>
          </div>
