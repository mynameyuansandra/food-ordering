      ...
      <div class="container">
          <div class="col-md-12">
              <ul class="breadcrumb">
                  ...
                  <li class="li">Ice Tea Strawberry</li>
              </ul>
          </div>
...
<!-- order -->
         <div class="col-md-9">
             <div id="productMain" class="row">
                         ...
                         <div id="myCarousel" class="carousel slide" data-ride="carousel">
                             ...
                             <div class="carousel-inner">
                                 <div class="item active">
                                     <center><img class="img-responsive" src="imagesminuman/jellystrawberryicetea.jpg" alt="Product 3-a"></center>
                                 </div>
                                 <div class="item">
                                     <center><img class="img-responsive" src="imagesminuman/jellystrawberryicetea.jpg" alt=""></center>
                                 </div>
                                 <div class="item">
                                     <center><img class="img-responsive" src="imagesminuman/jellystrawberryicetea.jpg" alt=""></center>
                                 </div>
                ...
                <div class="col-sm-6">
                    <div class="box">
                        <h1 class="text-center">Ice Tea Strawberry</h1>
                        ...
                        <?php
                            ...
                            ?>
                             ...
                             <!-- div.col-md-7>select.form-control>option*5 -->
                              ...
                              <div class="form-group">
                                <label for="" class="col-md-5 control-label">Menu Minuman
                                </label>
                                <?php $gambar = query("SELECT * FROM stok_makanan_masuk")[13] ?>
                                <div class="col-md-7">
                                    <input type="text" class="form-control" name="namamakanan" id="namamakanan"
                                    
                                     value="<?php echo $gambar['stok_menu_makanan'];?>" readonly="">
                            ...
                            <label for="" class="col-md-5 control-label">Nama Pelanggan
                                ...
                                <div class="col-md-7">
                                    <input type="text" class="form-control" name="nama_pelanggan" id="namapelanggan" autocomplete="off">
                    ...
                    <div class="row" id="thumbs">
                        ...
                        <img src="imagesminuman/jellystrawberryicetea.jpg" alt="product 1" class="img-responsive"></a>
                        </div>
