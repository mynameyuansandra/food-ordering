...
$id = $_GET['id'];
$pengiriman = query("SELECT * FROM konf_pengiriman WHERE id_konf = $id")[0];


if(isset($_POST['btnpengiriman']))
{
    if(updatepengiriman($_POST) > 0)
    {
        echo "<script>
            alert('Ubah Pengiriman Data Berhasil !');
            window.location.href='detailpengiriman.php';
        </script>";
    } 
        ...
        echo "<script>
            alert(' Ubah Pengiriman Data Gagal !');
            window.location.href='detailpengiriman.php';
        </script>";
    }
}
          ...
          <div class="col-md-9">
              <div class="box">
                  <div class="box-header">
                      ...
                      <input type="hidden" id="id" name="id" value="<?php echo $pengiriman['id_konf']; ?>">
                      ...
                      ?>  
                          ...
                          <div class="form-group">
                              ...
                              <input type="text" class="form-control" name="jumlah_pesan" 
                                id="jumlah_pesan" readonly="">
                              </div>
                          </div>
