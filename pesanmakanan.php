...
if (!isset($_GET['id'])) {
    ...
    $makanan = query("SELECT * FROM stok_makanan_masuk WHERE id_stok_makanan = $id");
    if (count($makanan) > 0) {
        $makanan = $makanan[0];
    }
    else {
...
if(isset($_POST['pesan']))
{
    if(pesan($_POST) > 0)
    {
        echo "<script>
            ...
            window.location.href='pesanmakanan.php?id=$id';
        </script>";
    }
...
<!-- order -->
         <div class="col-md-9">
             <div id="productMain" class="row">
                         ...
                         <div id="myCarousel" class="carousel slide" data-ride="carousel">
                             ...
                             <div class="carousel-inner">
                                 <div class="item active">
                                     <center><img class="img-responsive" src="img/<?= $makanan['gambar'] ?>" alt="<?= $makanan['nama_makanan'] ?>"></center>
                                 </div>
                                 <div class="item">
                                     <center><img class="img-responsive" src="img/<?= $makanan['gambar'] ?>" alt="<?= $makanan['nama_makanan'] ?>"></center>
                                 </div>
                ...
                <div class="col-sm-6">
                    <div class="box">
                        <h1 class="text-center">Nasi Goreng</h1>
                        <form action="" class="form-horizontal" method="post">
                        <input type="hidden" name="id_stok_makanan" value="<?= $id ?>">
                        ...
                        <?php
                            ...
                            <div class="form-group">
                                <label for="" class="col-md-5 control-label">Nama Makanan
                                </label>
                                <div class="col-md-7">
                                    <input type="text" class="form-control" name="namamakanan" id="namamakanan"
                            ...
                            <label for="" class="col-md-5 control-label">Nama Pelanggan
                                ...
                                <div class="col-md-7">
                                    <input type="text" class="form-control" name="nama_pelanggan" value="" id="namapelanggan">
                            ...
                            <div class="form-group">
                                ...
                                <?php $gambar = query("SELECT * FROM stok_makanan_masuk")[0] ?>
                                <div class="col-md-7">
                                    <input type="text" class="form-control" name="gambar" id="gambar"
                                    
                                     value="<?php echo $gambar['gambar'];?>" readonly="">

                                </div>
                            </div>
                            <!-- div.form-group>.col-md-5.control-panel -->
                            
                            <p class="text-center buttons control-label"><button type="submit" name="pesan" class="btn btn-primary ">Pesan</button></p>
                        </form>
                    </div>
                    ...
                    <div class="row" id="thumbs">
                        ...
                        <img src="imagesmakanan/nasigorengkampung.jpg" alt="product 1" class="img-responsive"></a>
                        </div>
