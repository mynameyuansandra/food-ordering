...
$detailorder = query("SELECT * FROM detail_order ORDER BY id_detail DESC");




if (isset($_POST['cari'])) {
  $detailorder = cariorder($_POST['search']);
}
    ...
    <div class="container">
      <div class="col-md-12">
        <ul class="breadcrumb">
          ...
          <li class="li">Data Detail Order</li>
        </ul>
      </div>
        ...
        <div class="box">
          <div class="box-header">
            <div class="form-group">
              <div class="input-group">
                <div class="pull-right">
                  <a href="cetaksemuaorder.php" class="btn btn-primary" style="margin-bottom:20px;" target="_blank">
            ...
            <table class="table table-striped table-bordered">
              ...
              <?php $numb = 1; ?>
              <?php foreach ($detailorder as $row) : ?>
                ...
                <tbody>
                  <tr>
                    ...
                    <td>
                      <a href="deleteorder.php?id=<?php echo $row['id_detail']; ?>" onclick="return confirm('Apakah anda yakin ingin menghapus')" ; class="btn btn-danger btn-xs" style="margin-right:0;"><i class="fa fa-trash-o" aria-hidden="true"></i>
                      </a> |


                      <a href="cetakorder.php?id=<?php echo $row['id_detail']; ?>" target="_blank" class="btn btn-primary btn-xs" style="margin-right:0;"><i class="fa fa-print" aria-hidden="true"></i></i>
                      </a>
                    </td>
