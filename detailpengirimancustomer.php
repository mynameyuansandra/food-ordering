...
$monitoring = query("SELECT * FROM konf_pengiriman WHERE nama_pelanggan = '$nama' ORDER BY id_konf DESC");
                            ...
                            <?php foreach ($monitoring as $row) : ?>
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td><?= $row['status'] ?></td>
                                        <td>
                                            <a href="deletepengirimancustomer.php?id=<?php echo $row['id_konf']; ?>" onclick="return confirm('Apakah anda yakin ingin menghapus')" ; class="btn btn-danger btn-xs" style="margin-right:0;"><i class="fa fa-trash-o" aria-hidden="true"></i>
                                            </a> |

                                            <a href="updatepengirimancustomer.php?id=<?php echo $row['id_konf']; ?>" class="btn btn-info btn-xs" style="margin-right:0;"><i class="fa fa-trash-o" aria-hidden="true"></i>
                                            </a>
                                            |
                                            <a href="cetakpengirimancustomer.php" target="_blank" class="btn btn-primary btn-xs" style="margin-right:0;"><i class="fa fa-print" aria-hidden="true"></i></i>
                                            </a>
                                        </td>
